...
setInterval( () => console.log('entrou no log'), 2000)
...
function exerciceTwo(nameParametro){
  return nameParametro = 'otavio'
}
// logGreeting(exerciceTwo())
...
const lesserThanFive = numbers.filter(result)
...
const totalPrice = prices.reduce(getTotalPrice, 0);// maneira do professor

// prices.forEach(item => totalPrice += item)//fiz dessa maneira, e está correta
...
// const exerciceSix = (arg1, arg2, arg3) => {
//   const receba = [arg1,arg2,arg3].includes(undefined)
//   return receba ? 'A função deve ser invocada com 3 argumentos'
//   : 'A função foi invocada com 3 argumentos';
 
// }

// console.log(exerciceSix(1,3,4))
