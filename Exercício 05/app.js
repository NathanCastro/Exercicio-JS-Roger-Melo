...
//console.log(`A soma de "numbers" é:${soma} é True ou False: ${soma == 337}`);
...
for(let i = 0; i < 5; i++){
  console.log(`O Loop roda: ${i}`);
}
 console.log('loop concluído')

const nameProperty = ['Linus', 'Ada', 'BIll'];
for (let index = 0; index < nameProperty.length; index++) {
   //console.log(nameProperty[index]);    
   const HTMLTemplate = `<p>${nameProperty[index]}</p>`
   //console.log(HTMLTemplate);    
}

// Módulo 2 Aula 4(While)

let i = 0;
nameFruit = ['Abacate','Laranja', 'kiwi']
while (i < 5) {
  console.log(nameFruit[i]);
  i++  
}
*/