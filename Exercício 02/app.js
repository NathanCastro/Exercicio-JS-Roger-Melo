...
// const getJ = programmingLanguage.charAt(0);
// const getS = programmingLanguage.charAt(4);
//const js = getJ + getS
 //console.log(js);
...
Nesse exercicio pode ser feito de várias formas.
.substr(-1)
.charAt()  console.log(randomWord.charAt(a.length - 1));
.slice() console.log(randomWord.slice(-1));
...
- Abaixo deste comentário, armazene a string 'O nº de episódios é: NUMERO_DE_EPISÓDIOS' 
...
- A template string deverá resultar no mesmo valor que a "newName" tinha anteriormente
  (nome e sobrenome com letras iniciais maiúsculas);
- Não digite a nova string manualmente.
- Não modifique a string da const "name";
- Exiba a "newName" no console;
*/
