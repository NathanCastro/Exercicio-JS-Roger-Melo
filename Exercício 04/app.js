...
*/
const my3FavoriteTVShows = ['prision break', 'Game of Thrones', 'The office'];
...
//const isRandomTVShowIncluded = randomTVShow.includes(my3FavoriteTVShows) //fiz assim
// const isRandomTVShowIncluded3 = my3FavoriteTVShows.includes(randomTVShow) professor fez assim
//console.log(isRandomTVShowIncluded, isRandomTVShowIncluded3);
...
*/
const toCheck = 39;
//console.log(`A string que a "typeSentence" armazena tem mais de ${toCheck} caracteres? ${String(typeSentence.length > toCheck).replace('t', 'T')}`)
...
/*Sempre que utiliza executamos uma operação matemática usando o NULL, ele é avaliado como 0*/
